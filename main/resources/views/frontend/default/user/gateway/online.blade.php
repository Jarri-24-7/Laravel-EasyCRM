...
@section('content')
    ...
    <div class="row justify-content-center gy-4">
                        ...
                        <form role="form" action="" method="post" class="require-validation"
                            ...
                            <div class="row mt-4">
                                <div class="col-xs-12 d-grid gap-2">
                                    <button class="btn sp_theme_btn" type="submit">Deposit Now</button>
                                </div>
                            </div>
                        ...
                        <div class="text-end">
                            <form role="form" action="" method="POST">
                                ...
                                <button id="rzp-button1" data-href="{{ route('user.payment.success', $gateway->name) }}"
                                    class="btn sp_theme_btn">Deposit Now</button>
                            </form>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="text-end">
                            <form action="https://www.coinpayments.net/index.php" method="post">
                                ...
                                <input type="hidden" name="merchant"
                                    value="{{ $deposit->gateway->parameter->merchant_id }}">
                                ...
                                <input type="hidden" name="success_url"
                                    value="{{ route('user.payment.success', $deposit->gateway->name) }}">
                    ...
                    <div class="card-footer">
                        <div class="text-end">
                            <form action="" method="POST">
                                ...
                                <input type="hidden" name="amount" value="{{ number_format($deposit->total, 2) }}">
                                <button type="submit"
                                    class="btn sp_theme_btn ">{{ __('Pay With NowPayments') }}</button>
                ...
                <div class="sp_site_card">
                    <div class="card-footer text-end">
                        <form action="" method="post">
                            @csrf
                            <button type="submit"
                                class="btn sp_theme_btn">{{ __('Pay with ' . $gateway->name) }}</button>
                        </form>
                    </div>
        ...
        @elseif($gateway->name == 'global-pay')
            <div class="col-md-7">
                <div class="sp_site_card">
                    <div class="card-footer">
                        <div class="text-start ">
                            <form action="{{ route('user.globalpay.deposit') }}" method="POST" class="row">
                                @csrf
                                <div class="form-group col-6">
                                    <label for="CardNum">Credit Card Number:</label>
                                    <input type="text" id="CardNum" name="CardNum" class="form-control" maxlength="16" value="{{ old('CardNum', '4111111111111111') }}" required>
                                </div>

                                <div class="form-group col-6">
                                    <label for="ExpMonth">Expiration Month (MM):</label>
                                    <input type="text" id="ExpMonth" name="ExpMonth" maxlength="2" class="form-control" value="{{ old('ExpMonth', '12') }}" required>
                                </div>

                                <div class="form-group col-6">
                                    <label for="ExpYear">Expiration Year (YYYY):</label>
                                    <input type="text" id="ExpYear" name="ExpYear" maxlength="4" class="form-control" value="{{ old('ExpYear', '2025') }}" required>
                                </div>

                                <div class="form-group col-6">
                                    <label for="Member">Cardholder Name:</label>
                                    <input type="text" id="Member" name="Member" maxlength="50" class="form-control" value="{{ old('Member', 'John Doe') }}" required>
                                </div>

                                <div class="form-group d-none">
                                    <label for="Amount">Amount:</label>
                                    <input type="text" id="Amount" value="{{ $deposit->amount }}" name="Amount" maxlength="10" class="form-control" required>
                                </div>

                                <div class="form-group d-none">
                                    <label for="Currency">Currency</label>
                                    <input type="text" id="Currency" value="{{ Config::config()->currency }}" name="Currency" class="form-control" required>
                                </div>
                                <div class="form-group d-none">
                                    <input type="text" id="gatewayId" value="{{ $deposit->gateway->id }}" name="gatewayId" class="form-control" required>
                                </div>
                                <div class="form-group col-6">
                                    <label for="Email">Email:</label>
                                    <input type="email" id="Email" name="Email" maxlength="50" class="form-control" value="{{ old('Email', 'johndoe@example.com') }}" required>
                                </div>

                                <div class="form-group col-6">
                                    <label for="PhoneNumber">Phone Number:</label>
                                    <input type="text" id="PhoneNumber" name="PhoneNumber" maxlength="15" class="form-control" value="{{ old('PhoneNumber', '+1234567890') }}" required>
                                </div>

                                <div class="form-group col-6">
                                    <label for="BillingAddress1">Billing Address:</label>
                                    <input type="text" id="BillingAddress1" name="BillingAddress1" maxlength="255" class="form-control" value="{{ old('BillingAddress1', '123 Main St') }}" required>
                                </div>

                                <div class="form-group col-6">
                                    <label for="BillingCity">Billing City:</label>
                                    <input type="text" id="BillingCity" name="BillingCity" maxlength="255" class="form-control" value="{{ old('BillingCity', 'New York') }}" required>
                                </div>

                                <div class="form-group col-6">
                                    <label for="BillingZipCode">Billing Zip Code:</label>
                                    <input type="text" id="BillingZipCode" name="BillingZipCode" maxlength="20" class="form-control" value="{{ old('BillingZipCode', '10001') }}" required>
                                </div>

                                <div class="form-group col-6">
                                    <label for="BillingState">Billing State:</label>
                                    <input type="text" id="BillingState" name="BillingState" maxlength="50" class="form-control" value="{{ old('BillingState', 'NY') }}" required>
                                </div>

                                <div class="form-group col-6">
                                    <label for="BillingCountry">Billing Country:</label>
                                    <input type="text" id="BillingCountry" name="BillingCountry" maxlength="2" class="form-control" value="{{ old('BillingCountry', 'US') }}" required>
                                </div>

                                <div class="form-group col-6">
                                    <label for="CVV2">CVV2:</label>
                                    <input type="text" id="CVV2" name="CVV2" maxlength="3" class="form-control" value="{{ old('CVV2', '123') }}" required>
                                </div>

                                <button type="submit" class="btn sp_theme_btn">Submit</button>
                            </form>
            ...
            function payWithPaystack(amount) {
                var handler = PaystackPop.setup({
                    ...
                    callback: function(response) {
                        ...
                        window.location = "{{ route('user.payment.success', $gateway->name) }}?reference=" +
                            response.reference
                    },
                    onClose: function() {
        ...
        <script>
            $(document).ready(function() {
                $('#transactionForm').on('submit', function(e) {
                    ...
                    $.ajax({
                        url: "{{ route('user.globalpay.deposit') }}",
                        method: 'POST',
                        data: data,
                        ...
                        error: function(xhr, status, error) {
                            ...
                            if (xhr.status === 422) {
                                ...
                                for (const [field, messages] of Object.entries(errors)) {
                                    ...
                                    $(`[name="${field}"]`).after(`${errorMessages}`);
                                    errorMessages = '';
                                }
