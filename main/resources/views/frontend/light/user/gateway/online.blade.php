...
@section('content')
    ...
    <div class="row justify-content-center gy-4">
                            ...
                            <form action="{{ route('user.globalpay.deposit') }}" method="POST" class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" id="CardNum" name="CardNum" class="form-control"
                                        maxlength="16" value="{{ old('CardNum') }}" required>
                                </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" id="Member" name="Member" maxlength="50"
                                        class="form-control" value="{{ old('Member') }}" required>
                                </div>

                                <div class="form-group d-none">
                                    <label for="Amount">Amount:</label>
                                    <input type="text" id="Amount" value="{{ $deposit->amount }}" name="Amount"
                                        maxlength="10" class="form-control" required>
                                </div>

                                <div class="form-group d-none">
                                    <label for="Currency">Currency</label>
                                    <input type="text" id="Currency" value="{{ Config::config()->currency }}"
                                        name="Currency" class="form-control" required>
                                </div>
                                <div class="form-group d-none">
                                    <input type="text" id="gatewayId" value="{{ $deposit->gateway->id }}"
                                        name="gatewayId" class="form-control" required>
                                </div>
                                <div class="form-group col-6">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" id="BillingAddress1" name="BillingAddress1" maxlength="255"
                                        class="form-control" value="{{ old('BillingAddress1') }}"
                                        required>
                                </div>

                                <div class="form-group col-6">
                                    <label for="BillingCity">Billing City:</label>
                                    <input type="text" id="BillingCity" name="BillingCity" maxlength="255"
                                        class="form-control" value="{{ old('BillingCity') }}" required>
                                </div>

                                <div class="form-group col-6">
                                    <label for="BillingZipCode">Billing Zip Code:</label>
                                    <input type="text" id="BillingZipCode" name="BillingZipCode" maxlength="20"
                                        class="form-control" value="{{ old('BillingZipCode') }}" required>
                                </div>

                                <div class="form-group col-6">
                                    <label for="BillingState">Billing State:</label>
                                    <input type="text" id="BillingState" name="BillingState" maxlength="50"
                                        class="form-control" value="{{ old('BillingState') }}" required>
                                </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" id="CVV2" name="CVV2" maxlength="3"
                                        class="form-control" value="{{ old('CVV2') }}" required>
                                </div>
        ...
        @elseif($gateway->name == 'interac')
            <div class="col-md-7">
                <div class="sp_site_card">
                    <div class="card-footer">
                        <div class="text-start ">
                            <form action="{{ route('user.interac.deposit') }}" method="POST" class="row">
                                @csrf
                                <div class="form-group col-6">
        ...
        <script>
            $(document).ready(function() {
                $('#transactionForm').on('submit', function(e) {
                    ...
                    $.ajax({
                        url: "{{ route('user.interac.deposit') }}",
                        method: 'POST',
                        data: data,
                        success: function(response) {
                            console.log('Response:', response);
