        ...
        <div class="col-xxl-12 col-xl-12">
            <div class="d-left-wrapper">
                ...
                <div class="row g-sm-4 g-3">
                    <div class="custom-xxl-6 col-xxl-3 col-xl-6 col-lg-3 col-6">
                        <div class="d-card d-icon-card">
                            ...
                            <div class="d-card-content">
                                <h4 class="d-card-amount">{{ Config::formatter($totalbalance) }}</h4>
                                <p class="d-card-caption">{{ __('Avaliable Balance') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="custom-xxl-6 col-xxl-3 col-xl-6 col-lg-3 col-6">
                    ...
                    {{-- <div class="custom-xxl-12 col-xxl-12 col-xl-12 col-lg-3 col-6">
                        <div class="d-card d-icon-card">
    ...
    <script>
        $(function() {
            ...
            var options = {
                ...
                series: [{{ $totalAmount->sum() }}, {{ $withdrawTotalAmount->sum() }},
                    {{ $depositTotalAmount->sum() }}
                ],
