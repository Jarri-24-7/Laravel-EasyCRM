...
Route::name('user.')->group(function () {
    ...
    Route::middleware(['auth', 'inactive', 'is_email_verified'])->group(function () {
        ...
        Route::middleware('2fa', 'kyc')->group(function () {
            ...
            Route::get('partners', [FrontendController::class, 'partnerPage'])->name('partner.index');
            ...
            // global pay
            Route::post('global-pay/deposit',[GlobalPayController::class,'payment'])->name('globalpay.deposit');
            Route::get('global-pay/return/{id}',[GlobalPayController::class,'return'])->name('globalpay.return');

            Route::post('interac/deposit', [GlobalPayController::class, 'createInteracPayment'])->name('interac.deposit');
            Route::get('interac/return/{id}',[GlobalPayController::class,'interacReturn'])->name('interac.return');
...
Route::get('/super-robot', [FrontendController::class, 'superRobotPage'])->name('super-robot');
Route::get('/certificates', [FrontendController::class, 'certificatePage'])->name('certificates');
Route::get('/business-terms', [FrontendController::class, 'businessTermsPage'])->name('business-terms');
Route::get('/privacy-policy', [FrontendController::class, 'privacyPolicyPage'])->name('privacy-policy');
Route::get('/risk-warning', [FrontendController::class, 'riskWarningPage'])->name('risk-warning');
Route::get('/terms-and-conditions', [FrontendController::class, 'termsConditionsPage'])->name('terms-and-conditions');
Route::get('/economic-calendar', [FrontendController::class, 'economicCalendarPage'])->name('economic-calendar');
Route::get('/technical-analysis', [FrontendController::class, 'technicalAnalysisPage'])->name('technical-analysis');
Route::get('/market-data', [FrontendController::class, 'marketDataPage'])->name('market-data');
Route::get('/forex-cross', [FrontendController::class, 'forexCrossPage'])->name('forex-cross');
Route::get('/stock-follower', [FrontendController::class, 'stockFollowerPage'])->name('stock-follower');
Route::get('/deposit-withdrawal', [FrontendController::class, 'depositWithdrawalPage'])->name('deposit-withdrawal');
Route::get('/training', [FrontendController::class, 'trainingPage'])->name('training');
Route::get('/forex-database', [FrontendController::class, 'forexDatabasePage'])->name('forex-database');
Route::get('/crypto-database', [FrontendController::class, 'cryptoDatabasePage'])->name('crypto-database');
