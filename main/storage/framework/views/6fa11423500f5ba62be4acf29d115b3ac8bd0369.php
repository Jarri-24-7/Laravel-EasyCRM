        ...
        <div class="row gy-5 align-items-center justify-content-between">
            <div class="col-lg-7 ps-lg-5 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.5s">
                <h2 class="sp_theme_top_title">
                    <?php echo Config::colorText(optional($content)->title . ' ' . optional($content)->color_text_for_title, optional($content)->color_text_for_title); ?>
...
</section><?php /**PATH E:\xampp\htdocs\strong-capitals\main\resources\views/frontend/light/widgets/about.blade.php ENDPATH**/ ?>