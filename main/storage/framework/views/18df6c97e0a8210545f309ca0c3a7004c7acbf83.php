...
<head>
    ...
    <link href="<?php echo e(Config::cssLib('frontend', 'owl.carousel.min.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <?php endif; ?>
    <script src="<?php echo e(Config::jsLib('frontend', 'owl.carousel.min.js')); ?>"></script>
...
<?php /**PATH E:\xampp\htdocs\strong-capitals\main\resources\views/frontend/light/layout/master.blade.php ENDPATH**/ ?>