        ...
        <div class="row gy-5 justify-content-lg-between justify-content-center align-items-center">
            <div class="col-lg-7 text-lg-start text-center">
                <h2 class="sp_banner_title wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.3s">
                    <?php echo Config::colorText(optional($banner->content)->title . ' ' . optional($banner->content)->color_text_for_title, optional($banner->content)->color_text_for_title); ?>
...
<!-- banner section end --><?php /**PATH E:\xampp\htdocs\strong-capitals\main\resources\views/frontend/light/widgets/banner.blade.php ENDPATH**/ ?>