        ...
        <div class="row justify-content-center">
            <div class="col-lg-7 text-center">
                <div class="sp_theme_top  wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.3s">
                    ...
                    <h2 class="sp_theme_top_title"><?php echo Config::colorText(optional($content)->title . ' ' . optional($content)->color_text_for_title, optional($content)->color_text_for_title); ?>
...
<!-- how work section end --><?php /**PATH E:\xampp\htdocs\strong-capitals\main\resources\views/frontend/light/widgets/how_works.blade.php ENDPATH**/ ?>